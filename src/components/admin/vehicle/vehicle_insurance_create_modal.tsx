...
interface VehicleInsuranceCreateModalProps {
 ...
 * # 创建车辆保险模态框组件
 */
export function VehicleInsuranceCreateModal({ formData, setFormData, vehicles, onConfirm, onCancel }: VehicleInsuranceCreateModalProps) {
        ...
        <div className="modal modal-open">
            <div className="modal-box w-11/12 max-w-4xl">
                ...
                <div className="flex items-center justify-between mb-6">
                    <h3 className="text-xl font-bold">添加保险记录</h3>
