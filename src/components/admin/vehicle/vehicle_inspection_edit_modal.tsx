...
interface VehicleInspectionEditModalProps {
 ...
 * # 编辑车辆年检模态框组件
 */
export function VehicleInspectionEditModal({ formData, setFormData, vehicles, onConfirm, onCancel }: VehicleInspectionEditModalProps) {
        ...
        <div className="modal modal-open">
            <div className="modal-box w-11/12 max-w-4xl">
                ...
                <div className="flex items-center justify-between mb-6">
                    <h3 className="text-xl font-bold">编辑年检记录</h3>
